...
class InviteAcceptTests(unittest.TestCase, _PortalHarness):
    ...
    def test_employee_invite_accept_page_includes_install_and_portal_tour(self):
        ...
        self.assertIn("Create login", r.text)
        self.assertIn("Add contact info", r.text)
        self.assertIn("Install on phone", r.text)
        self.assertIn("Learn shifts, hours, and pay", r.text)
        self.assertIn("Add this to your phone.", r.text)
        self.assertIn("degen-collectibles-180.png", r.text)
        self.assertIn("leave the name as Degen", r.text)
        self.assertIn("Safari on iPhone or Chrome on Android", r.text)
        self.assertIn("Add Degen to your Home Screen", r.text)
        self.assertIn("Opened this on the wrong device?", r.text)
        self.assertIn("Copy link", r.text)
        self.assertIn("Text this link to my phone", r.text)
        self.assertIn("I'll add this later", r.text)
    ...
    def test_manager_invite_accept_page_includes_manager_portal_tour(self):
        ...
        self.assertIn("Remember one thing: Admin → Schedule → Edit schedule.", r.text)
...
class SupplyAndPoliciesTests(unittest.TestCase, _PortalHarness):
    ...
    def test_help_page_includes_phone_install_guide_and_tour_link(self):
        ...
        self.assertIn("iPhone: tap Share. Android: tap the three-dot menu.", page.text)
    ...
    def test_team_admin_tutorial_explains_schedule_and_admin_pages(self):
        ...
        self.assertIn("Click an empty cell and add the shift.", page.text)
        ...
        self.assertIn("Hidden by role/permission", page.text)
