...
class Settings(BaseSettings):
    ...
    inventory_price_review_threshold_percent: float = Field(default=10.0, alias="INVENTORY_PRICE_REVIEW_THRESHOLD_PERCENT")
    inventory_price_review_threshold_dollars: float = Field(default=5.0, alias="INVENTORY_PRICE_REVIEW_THRESHOLD_DOLLARS")
