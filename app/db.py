...
SQLITE_ADDITIVE_MIGRATIONS = {
    ...
    "inventory_items": {
        ...
        "shopify_sync_enabled": "BOOLEAN DEFAULT 1",
        "shopify_synced_at": "TIMESTAMP",
        "shopify_sync_status": "TEXT DEFAULT 'not_synced'",
        "shopify_sync_error": "TEXT",
        "shopify_last_payload_json": "TEXT DEFAULT '{}'",
        "resticker_alert_active": "BOOLEAN DEFAULT 0",
        "resticker_alerted_at": "TIMESTAMP",
        "resticker_resolved_at": "TIMESTAMP",
        "resticker_reference_price": "REAL",
        "resticker_alert_price": "REAL",
        "resticker_alert_reason": "TEXT",
...
SQLITE_INDEX_MIGRATIONS = [
    ...
    "CREATE INDEX IF NOT EXISTS idx_inventory_items_shopify_variant_id ON inventory_items (shopify_variant_id)",
    "CREATE INDEX IF NOT EXISTS idx_inventory_items_shopify_inventory_item_id ON inventory_items (shopify_inventory_item_id)",
    "CREATE INDEX IF NOT EXISTS idx_inventory_items_shopify_location_id ON inventory_items (shopify_location_id)",
    "CREATE INDEX IF NOT EXISTS idx_inventory_items_shopify_sku ON inventory_items (shopify_sku)",
    "CREATE INDEX IF NOT EXISTS idx_inventory_items_shopify_sync_enabled ON inventory_items (shopify_sync_enabled)",
    "CREATE INDEX IF NOT EXISTS idx_inventory_items_shopify_sync_status ON inventory_items (shopify_sync_status)",
    "CREATE INDEX IF NOT EXISTS idx_inventory_items_shopify_synced_at ON inventory_items (shopify_synced_at)",
    "CREATE INDEX IF NOT EXISTS idx_inventory_items_resticker_alert_active ON inventory_items (resticker_alert_active)",
    "CREATE INDEX IF NOT EXISTS idx_inventory_items_resticker_alerted_at ON inventory_items (resticker_alerted_at)",
    "CREATE INDEX IF NOT EXISTS idx_inventory_items_resticker_resolved_at ON inventory_items (resticker_resolved_at)",
    "CREATE INDEX IF NOT EXISTS idx_inventory_items_archived_at ON inventory_items (archived_at)",
    "CREATE INDEX IF NOT EXISTS idx_inventory_items_archived_by ON inventory_items (archived_by)",
    ...
    "CREATE INDEX IF NOT EXISTS idx_bank_transactions_provider_transaction_id ON bank_transactions (provider_transaction_id)",
    "CREATE INDEX IF NOT EXISTS idx_bank_transactions_pending ON bank_transactions (pending)",
    "CREATE INDEX IF NOT EXISTS idx_bank_transactions_pending_transaction_id ON bank_transactions (pending_transaction_id)",
    "CREATE INDEX IF NOT EXISTS idx_bank_transactions_is_removed ON bank_transactions (is_removed)",
    ...
    "CREATE INDEX IF NOT EXISTS idx_ledger_rules_last_applied_at ON ledger_rules (last_applied_at)",
    "CREATE INDEX IF NOT EXISTS idx_bank_statement_imports_provider ON bank_statement_imports (provider)",
    "CREATE INDEX IF NOT EXISTS idx_bank_statement_imports_provider_item_id ON bank_statement_imports (provider_item_id)",
    "CREATE INDEX IF NOT EXISTS idx_bank_statement_imports_provider_account_id ON bank_statement_imports (provider_account_id)",
    "CREATE INDEX IF NOT EXISTS idx_bank_statement_imports_last_sync_at ON bank_statement_imports (last_sync_at)",
    "CREATE INDEX IF NOT EXISTS idx_bank_feed_connections_provider ON bank_feed_connections (provider)",
    "CREATE UNIQUE INDEX IF NOT EXISTS idx_bank_feed_connections_provider_item_id ON bank_feed_connections (provider_item_id)",
    "CREATE INDEX IF NOT EXISTS idx_bank_feed_connections_institution_id ON bank_feed_connections (institution_id)",
    "CREATE INDEX IF NOT EXISTS idx_bank_feed_connections_institution_name ON bank_feed_connections (institution_name)",
    "CREATE INDEX IF NOT EXISTS idx_bank_feed_connections_status ON bank_feed_connections (status)",
    "CREATE INDEX IF NOT EXISTS idx_bank_feed_connections_last_sync_at ON bank_feed_connections (last_sync_at)",
    "CREATE INDEX IF NOT EXISTS idx_bank_feed_accounts_connection_id ON bank_feed_accounts (connection_id)",
    "CREATE INDEX IF NOT EXISTS idx_bank_feed_accounts_bank_import_id ON bank_feed_accounts (bank_import_id)",
    "CREATE UNIQUE INDEX IF NOT EXISTS idx_bank_feed_accounts_provider_account_id ON bank_feed_accounts (provider_account_id)",
    "CREATE INDEX IF NOT EXISTS idx_bank_feed_accounts_account_label ON bank_feed_accounts (account_label)",
    "CREATE INDEX IF NOT EXISTS idx_bank_feed_accounts_account_type ON bank_feed_accounts (account_type)",
    "CREATE INDEX IF NOT EXISTS idx_bank_feed_accounts_account_subtype ON bank_feed_accounts (account_subtype)",
    "CREATE INDEX IF NOT EXISTS idx_bank_feed_accounts_mask ON bank_feed_accounts (mask)",
    "CREATE INDEX IF NOT EXISTS idx_bank_feed_accounts_iso_currency_code ON bank_feed_accounts (iso_currency_code)",
    "CREATE INDEX IF NOT EXISTS idx_bank_feed_accounts_is_active ON bank_feed_accounts (is_active)",
    ...
    "CREATE INDEX IF NOT EXISTS idx_shopify_sync_issues_status ON shopify_sync_issues (status)",
    "CREATE INDEX IF NOT EXISTS idx_shopify_sync_issues_issue_type ON shopify_sync_issues (issue_type)",
    "CREATE INDEX IF NOT EXISTS idx_shopify_sync_issues_shopify_sku ON shopify_sync_issues (shopify_sku)",
    "CREATE INDEX IF NOT EXISTS idx_shopify_sync_issues_shopify_product_id ON shopify_sync_issues (shopify_product_id)",
    "CREATE INDEX IF NOT EXISTS idx_shopify_sync_issues_shopify_variant_id ON shopify_sync_issues (shopify_variant_id)",
    "CREATE INDEX IF NOT EXISTS idx_shopify_sync_issues_inventory_item_id ON shopify_sync_issues (inventory_item_id)",
    "CREATE INDEX IF NOT EXISTS idx_shopify_sync_issues_last_seen_at ON shopify_sync_issues (last_seen_at)",
    "CREATE INDEX IF NOT EXISTS idx_shopify_sync_jobs_item_id ON shopify_sync_jobs (item_id)",
    "CREATE INDEX IF NOT EXISTS idx_shopify_sync_jobs_status ON shopify_sync_jobs (status)",
    "CREATE INDEX IF NOT EXISTS idx_shopify_sync_jobs_action ON shopify_sync_jobs (action)",
...
POSTGRES_ADDITIVE_MIGRATIONS = {
    ...
    "inventory_items": {
        ...
        "shopify_sync_error": "TEXT",
        "shopify_last_payload_json": "TEXT DEFAULT '{}'",
        "resticker_alert_active": "BOOLEAN DEFAULT FALSE",
        "resticker_alerted_at": "TIMESTAMP",
        "resticker_resolved_at": "TIMESTAMP",
        "resticker_reference_price": "DOUBLE PRECISION",
        "resticker_alert_price": "DOUBLE PRECISION",
        "resticker_alert_reason": "TEXT",
        "archived_at": "TIMESTAMP",
        "archived_by": "TEXT",
        "archive_reason": "TEXT",
